...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.cors.cors_listener' => 'getApp_Cors_CorsListenerService',
            ...
            'user_provider' => 'getUserProviderService',
            'user_repo' => 'getUserRepoService',
    ...
    /**
     * Gets the 'app.cors.cors_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\EventListener\CorsListener A AppBundle\EventListener\CorsListener instance.
     */
    protected function getApp_Cors_CorsListenerService()
    {
        return $this->services['app.cors.cors_listener'] = new \AppBundle\EventListener\CorsListener();
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('kernel.response', array(0 => 'app.cors.cors_listener', 1 => 'onKernelResponse'), 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'oauth2apitest', 'user' => 'jpa', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c->setEntityNamespaces(array('FOSOAuthServerBundle' => 'FOS\\OAuthServerBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_31c0dc90866dd2ae7c59e72201a6d4f9d7d12a2576d1680d38c5c793d08b5722');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt|error)|css|images|js)/'), 'security.firewall.map.context.oauth_token' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/oauth/v2/token'), 'security.firewall.map.context.oauth_authorize' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/oauth/v2/auth'), 'security.firewall.map.context.api' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/api'))), $this->get('debug.event_dispatcher'));
    }
    ...
    {
        $a = $this->get('fos_oauth_server.server');

        return $this->services['security.firewall.map.context.api'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \FOS\OAuthServerBundle\Security\Firewall\OAuthListener($this->get('security.context'), $this->get('security.authentication.manager'), $a), 2 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($this->get('security.token_storage'), $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'api', new \FOS\OAuthServerBundle\Security\EntryPoint\OAuthEntryPoint($a), NULL, NULL, $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_OauthAuthorizeService()
    {
        ...
        $f->setOptions(array('login_path' => 'oauth_login', 'always_use_default_target_path' => false, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $f->setProviderKey('oauth_authorize');

        $g = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array(), $b);
        $g->setOptions(array('login_path' => 'oauth_login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.oauth_authorize'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.in_memory'), 1 => $this->get('user_provider')), 'oauth_authorize', $b, $c), 2 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'oauth_authorize', $f, $g, array('check_path' => 'oauth_login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 3 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'oauth_authorize', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'oauth_login', false), NULL, NULL, $b));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0521cd07e4952cab6e4aa6a2706259aeb94ec0c3');
    }

    /**
     * Gets the 'user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Provider\UserProvider A AppBundle\Provider\UserProvider instance.
     */
    protected function getUserProviderService()
    {
        return $this->services['user_provider'] = new \AppBundle\Provider\UserProvider($this->get('user_repo'));
    }

    /**
     * Gets the 'user_repo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Entity\UserRepository A AppBundle\Entity\UserRepository instance.
     */
    protected function getUserRepoService()
    {
        return $this->services['user_repo'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AppBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($a, $b, 'oauth_authorize', $this->get('security.encoder_factory'), true), 1 => new \FOS\OAuthServerBundle\Security\Authentication\Provider\OAuthProvider($a, $this->get('fos_oauth_server.server'), $b)), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '0521cd07e4952cab6e4aa6a2706259aeb94ec0c3',
            ...
            'kernel.secret' => '0521cd07e4952cab6e4aa6a2706259aeb94ec0c3',
